...
function Login(_a) {
  ...
  var error = react_redux_1.useSelector(function (state) {
    return state.err;
  });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              async_storage_1['default'].removeItem('@user_token'),
            ];
          case 2:
            _a.sent();
            return [
              4 /*yield*/,
              async_storage_1['default'].setItem('@user_token', token),
            ];
          case 3:
            _a.sent();
            return [3 /*break*/, 5];
  ...
  return react_1['default'].createElement(
    ...
    react_1['default'].createElement(
      ...
      react_1['default'].createElement(
        theme_1.Text,
        {variant: 'title', color: 'primary', marginBottom: 'l'},
        'LOGIN',
      ),
      error.id === 'LOGIN_FAIL'
        ? react_1['default'].createElement(
      ...
      react_1['default'].createElement(
        theme_1.Box,
        {style: {width: width * 0.7}, marginBottom: 'm'},
      ...
      react_1['default'].createElement(
        ...
        {style: {marginTop: 30}, onPress: onRegister},
        react_1['default'].createElement(
          theme_1.Text,
          {variant: 'smtitle', color: 'primary'},
          'Register',
        ),
      ),
    ),
